...
class LinkFactoryTest {
    ...
    void createLinkProsecutionCaseTest() {
        assertEquals(BASE_URL + "/" + PSC_DISCREPANCY_REPORT_ID, underTest.createLinkPscDiscrepancyReport(PSC_DISCREPANCY_REPORT_ID));
    }

    @Test
    @DisplayName("createLinkPscDiscrepancies Test")
    void createLinkDefendants() {
        assertEquals(BASE_URL + "/" + PSC_DISCREPANCY_REPORT_ID + "/discrepancies", underTest.createLinkPscDiscrepancies(PSC_DISCREPANCY_REPORT_ID));
    }

    @Test
    @DisplayName("createLinkPscDiscrepancy Test")
    void createLinkDefendant() {
        assertEquals(BASE_URL + "/" + PSC_DISCREPANCY_REPORT_ID + "/discrepancies/" + PSC_DISCREPANCY_ID, underTest.createLinkPscDiscrepancy(PSC_DISCREPANCY_ID, PSC_DISCREPANCY_REPORT_ID));
    }
}
